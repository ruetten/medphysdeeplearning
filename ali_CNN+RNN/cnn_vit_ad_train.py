...
ViT_w_regularizer = regularizers.l2(1e-6)
CNN_batch_size = 10
ViT_batch_size = 5
val_split = 0.2
...
params_dict = { 
    'CNN_w_regularizer': CNN_w_regularizer, 
    'ViT_w_regularizer': ViT_w_regularizer,
    'CNN_batch_size': CNN_batch_size, 
    'ViT_batch_size': ViT_batch_size,
    'CNN_drop_rate': CNN_drop_rate, 
    'epochs': 2,
    'gpu': "/gpu:0", 
...
def evaluate_net (seed):
    ...
    train_data, val_data, test_data, vit_HdataT1, vit_HdataT2, vit_HdataT3, vit_AdataT1, vit_AdataT2, vit_AdataT3, test_mri_nonorm = data_loader.get_train_val_test(val_split, mri_datapath)
...
#Get the feature vectors from the final layer for each training image at each timepoint:
    vit_HpredsT1 = featuresModel_CNN.predict([vit_HdataT1[0],vit_HdataT1[1],vit_HdataT1[2]])
    vit_HpredsT2 = featuresModel_CNN.predict([vit_HdataT2[0],vit_HdataT2[1],vit_HdataT2[2]])
    vit_HpredsT3 = featuresModel_CNN.predict([vit_HdataT3[0],vit_HdataT3[1],vit_HdataT3[2]]) 
    vit_ApredsT1 = featuresModel_CNN.predict([vit_AdataT1[0],vit_AdataT1[1],vit_AdataT1[2]])
    vit_ApredsT2 = featuresModel_CNN.predict([vit_AdataT2[0],vit_AdataT2[1],vit_AdataT2[2]])
    vit_ApredsT3 = featuresModel_CNN.predict([vit_AdataT3[0],vit_AdataT3[1],vit_AdataT3[2]])     

#grab the PTIDs for each dataset
    rnn_HptidT1 = vit_HdataT1[4]
    rnn_HptidT2 = vit_HdataT2[4]
    rnn_HptidT3 = vit_HdataT3[4]
    rnn_AptidT1 = vit_AdataT1[4]
    rnn_AptidT2 = vit_AdataT2[4]
    rnn_AptidT3 = vit_AdataT3[4]
#grab the imageIDs for each dataset
    rnn_HimageIDT1 = vit_HdataT1[5]
    rnn_HimageIDT2 = vit_HdataT2[5]
    rnn_HimageIDT3 = vit_HdataT3[5]
    rnn_AimageIDT1 = vit_AdataT1[5]
    rnn_AimageIDT2 = vit_AdataT2[5]
    rnn_AimageIDT3 = vit_AdataT3[5]
...
#add dummy feature vectors to all missing timepoints
    ...
    for ptidT1 in rnn_HptidT1:
        rnn_HpredsT1_padded.append(vit_HpredsT1[j])
        ...
        for ptidT2 in rnn_HptidT2:
            c+=1
            if ptidT1 == ptidT2:
                rnn_HpredsT2_padded.append(vit_HpredsT2[c-1])
                ...
                for ptidT3 in rnn_HptidT3:
                    k+=1
                    if ptidT1 == ptidT3:
                        rnn_HpredsT3_padded.append(vit_HpredsT3[k-1])
...
#                break
    ...
    with open(model_filepath+'/figures/paddedPreds.txt','w') as paddedPreds:
            ...
            paddedPreds.write('Type of rnn_HpredsT1: '+str(type(vit_HpredsT1))+'\n')            
            ...
            paddedPreds.write('Type of rnn_HpredsT1 elements: '+str(type(vit_HpredsT1[0]))+'\n')            
            ...
            paddedPreds.write('Length of rnn_HpredsT1: '+str(len(vit_HpredsT1))+'\n')
            ...
            paddedPreds.write('Compare to RNN_HpredsT1: '+str(vit_HpredsT1)+'\n')
            ...
            paddedPreds.write('Shape of RNN_HpredsT1: '+str(vit_HpredsT1.shape)+'\n')
            paddedPreds.write('RNN_HpredsT1[0]: '+str(vit_HpredsT1[0])+'\n')
            paddedPreds.write('rnn_HpredsT1[0][0]: '+str(vit_HpredsT1[0][0])+'\n')
    ...
    for ptidT1 in rnn_AptidT1:
        rnn_ApredsT1_padded.append(vit_ApredsT1[j])
        ...
        for ptidT2 in rnn_AptidT2:
            c+=1
            if ptidT1 == ptidT2:
                rnn_ApredsT2_padded.append(vit_ApredsT2[c-1])
                ...
                for ptidT3 in rnn_AptidT3:
                    k+=1
                    if ptidT1 == ptidT3:
                        rnn_ApredsT3_padded.append(vit_ApredsT3[k-1])
